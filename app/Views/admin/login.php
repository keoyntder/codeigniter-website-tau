...
<div class="login-wrapper">
    ...
    <div class="login-left">
        ...
        <div class="branding">
            <img src="<?= base_url('assets/Images/taulogo.png') ?>" class="logo" alt="TAU Logo">
    ...
    <div class="login-right">
        <form action="<?= base_url('admin/login') ?>" method="post" class="login-card">
            <?= csrf_field() ?> 
            ...
            <div class="input-group">
                ...
                <div class="password-wrapper">
                    ...
                    <button type="button" id="togglePasswordBtn" class="toggle-password-btn" aria-label="Toggle password visibility">
                        ...
                        <svg id="eyeSlashIcon" class="hidden" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.8" stroke="currentColor">
