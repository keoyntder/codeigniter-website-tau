...
class CollegeSeeder extends Seeder
{
    public function run()
    {
        $data = [
            ...
            ['code' => 'cet',  'name' => 'College of Engineering and Technology','short_name' => 'Engineering and Technology','logo' => 'cetlogo.png', 'sort_order' => 3],
            ['code' => 'caf',  'name' => 'College of Agriculture and Forestry',  'short_name' => 'Agriculture and Forestry',  'logo' => 'caf.png',     'sort_order' => 4],
            ['code' => 'cvm',  'name' => 'College of Veterinary Medicine',       'short_name' => 'Veterinary Medicine',       'logo' => 'cvm.png',     'sort_order' => 5],
